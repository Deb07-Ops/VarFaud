                ...
                <div class="flex justify-start">
                  <div class="bg-blue-500 rounded-bl-none rounded-xl px-6 py-3 text-gray-700 backdrop-filter backdrop-blur-md bg-opacity-10 ">
                    <div class="test">
                      ...
                      <p>The input string "Hello, World!" is considered safe and doesn't need any special treatment, you don't necessarily need to sanitize it. However, if you want to ensure that it doesn't contain any unexpected characters or patterns, you can still apply a basic sanitization process.</p>
