                ...
                <div class="flex justify-end">
                  <div class="bg-orange-500 rounded-br-none rounded-xl px-6 py-3 text-gray-700 backdrop-filter backdrop-blur-md bg-opacity-10">
                    <div>
                      ...
                      <p>user_input = "<script>alert('XSS attack')</script>"</p>
                    </div>
                  </div>
                </div>
                <div class="flex justify-start">
                  <div class="bg-blue-500 rounded-bl-none rounded-xl px-6 py-3 text-gray-700 backdrop-filter backdrop-blur-md bg-opacity-10 ">
                    <div class="test">
                      ...
                      <p>To prevent XSS (Cross-Site Scripting) attacks, you need to sanitize user input to ensure that any HTML tags and JavaScript code are treated as plain text rather than executable code. Here's an example of how you can sanitize the input in JavaScript: // Output: &lt;script&gt;alert('XSS attack')&lt;/script&gt;</p>
